...
export const TAROT_CARDS: TarotCard[] = [
  {
    ...
    "readingAdvice": "Có một cảm giác chuyển động đang hiện diện trong cuộc sống của bạn lúc này, dù nó chưa rõ hình dạng cụ thể. Có thể đó là một quyết định bạn đang cân nhắc, một thay đổi hoàn cảnh sắp diễn ra, hay đơn giản là một cảm giác bên trong rằng đã đến lúc làm điều gì đó khác đi.",
  ...
  },
  {
    ...
    "readingAdvice": "Nhìn tổng thể cuộc sống lúc này, có một cảm giác rằng mọi công cụ cần thiết đã có sẵn trong tay bạn, kỹ năng, mối quan hệ, thời gian, hoặc chỉ đơn giản là sự rõ ràng về điều mình muốn hướng tới.",
  ...
  },
  {
    ...
    "readingAdvice": "Nhìn tổng thể cuộc sống lúc này, có một chất lượng lặng lẽ và hướng nội đang hiện diện, như thể bạn đang ở trong một giai đoạn chuẩn bị âm thầm hơn là hành động ồn ào ra bên ngoài.",
  ...
  },
  {
    ...
    "readingAdvice": "Giai đoạn này của bạn mang năng lượng của sự phát triển tự nhiên, giống như một mùa mà mọi thứ đang lớn lên đúng nhịp của nó, không cần bạn phải can thiệp quá nhiều.",
  ...
  },
  {
    ...
    "readingAdvice": "Giai đoạn này của cuộc sống có thể đang mời gọi bạn kết nối lại với những giá trị nền tảng, điều gì thực sự quan trọng với bạn, những nguyên tắc bạn muốn sống theo, hoặc cộng đồng và truyền thống mà bạn thuộc về.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở lớp tổng quát, lá này nói về những khoảnh khắc bạn được mời gọi chọn điều gì đó thật sự phù hợp với mình, thay vì điều dễ dàng hay quen thuộc. Có thể đó là một mối quan hệ, một công việc, một nhóm bạn, hoặc thậm chí là cách bạn phân bổ thời gian mỗi ngày.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở lớp tổng quát, lá này đánh dấu một giai đoạn bạn có đủ quyết tâm để đẩy mọi việc tiến lên, sau có thể là một thời gian cảm thấy giậm chân tại chỗ. Đây không phải năng lượng của sự may mắn tình cờ, mà là kết quả của việc bạn chủ động chọn hướng đi và dồn sức vào đó.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở lớp tổng quát, lá này nói về một loại sức mạnh không cần phô trương, thứ sức mạnh giúp bạn vẫn đứng vững khi mọi thứ xung quanh có phần hỗn loạn, không phải bằng cách chống lại bằng vũ lực mà bằng sự kiên định nhẹ nhàng.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác chuyển động đang xuất hiện trong cuộc sống của bạn gần đây, như thể một chương đang khép lại để nhường chỗ cho một chương khác, dù bạn có thể chưa hình dung rõ nó sẽ trông như thế nào.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống đôi khi đưa bạn vào một khoảng dừng mà bạn không hoàn toàn chọn nhưng cũng không hoàn toàn bị ép buộc, một trạng thái lơ lửng giữa việc tiếp tục và việc chờ đợi.",
  ...
  },
  {
    ...
    "readingAdvice": "Có những giai đoạn cuộc sống tự nhiên đi đến hồi kết, không phải vì có điều gì sai, mà vì chúng đã hoàn thành vai trò của mình trong hành trình của bạn.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác cân bằng đang len lỏi vào cuộc sống của bạn lúc này, như thể sau một giai đoạn xáo trộn, mọi thứ đang dần tìm được nhịp điệu ổn định hơn.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở lớp tổng quát, lá này chỉ ra một điều gì đó trong cuộc sống hiện tại của bạn đang được duy trì nhiều hơn vì quen thuộc hơn là vì nó thực sự phục vụ bạn.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở lớp tổng quát, lá này thường xuất hiện vào những giai đoạn có một biến động đến bất ngờ, làm thay đổi một phần cuộc sống mà bạn từng nghĩ là ổn định.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở lớp tổng quát, lá này thường xuất hiện như một dấu hiệu cho thấy bạn đang bước vào một giai đoạn nhẹ nhõm hơn sau một thời gian khó khăn hoặc căng thẳng kéo dài.",
  ...
  },
  {
    ...
    "readingAdvice": "Có những giai đoạn trong cuộc sống không đến với câu trả lời rõ ràng mà đến với nhiều câu hỏi hơn, và có vẻ như bạn đang ở trong một khoảng thời gian như vậy, nơi mọi thứ xung quanh lẫn bên trong đều mang một lớp sương mờ khó gọi tên chính xác.",
  ...
  },
  {
    ...
    "readingAdvice": "Có thể gần đây bạn cảm nhận được một luồng năng lượng tích cực lan tỏa trong nhiều mặt của cuộc sống, không nhất thiết là một sự kiện lớn lao nào đó, mà thường là một tổng hòa của những điều nhỏ đang diễn ra suôn sẻ cùng lúc, khiến bạn cảm thấy lạc quan và tràn đầy sức sống hơn bình thường.",
  ...
  },
  {
    ...
    "readingAdvice": "Có thể gần đây bạn cảm nhận được một sự thôi thúc rõ ràng phải đánh giá lại cuộc sống của mình theo một cách tổng thể hơn, nhìn lại những gì đã qua với một sự trung thực mà trước đây bạn chưa sẵn sàng đối diện.",
  ...
  },
  {
    ...
    "readingAdvice": "Bạn đang đứng ở điểm cuối của một hành trình đủ dài để nhìn lại và thấy nó có ý nghĩa, nơi những nỗ lực rải rác trong thời gian qua giờ đây gộp lại thành một kết quả có hình hài rõ ràng.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng năng lượng mới mẻ đang bước vào cuộc sống của bạn, mang cảm giác giống như một khởi đầu mà bạn có thể cảm nhận rõ ràng trước khi biết chính xác nó sẽ dẫn tới đâu.",
  ...
  },
  {
    ...
    "readingAdvice": "Bạn đang đứng ở một điểm nhìn thuận lợi trong cuộc sống, nơi bạn đã đủ vững vàng với hiện tại để bắt đầu nghĩ xa hơn về hướng đi tiếp theo, thay vì chỉ xử lý mọi việc theo quán tính từng ngày.",
  ...
  },
  {
    ...
    "readingAdvice": "Bạn đang ở một điểm nhìn cho phép thấy rõ hơn con đường phía trước, không phải toàn bộ chi tiết, nhưng đủ để cảm nhận hướng đi đang dần rõ ràng. Những nỗ lực bạn đã bỏ ra trong thời gian qua, dù nhỏ hay lớn, đang bắt đầu bước vào giai đoạn chờ kết quả, và điều quan trọng lúc này là giữ được sự kiên nhẫn thay vì hoài nghi quá sớm.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống của bạn đang bước vào một giai đoạn ổn định và đáng để ăn mừng, dù đó là một cột mốc lớn hay chỉ đơn giản là cảm giác mọi thứ đang vào guồng sau một thời gian xáo trộn.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống của bạn lúc này có thể đang có nhiều điểm ma sát hơn bình thường, bất đồng với người xung quanh, cảm giác phải cạnh tranh để giữ vị trí của mình, hoặc đơn giản là nhiều việc cùng lúc đòi hỏi sự chú ý theo những hướng khác nhau.",
  ...
  },
  {
    ...
    "readingAdvice": "Có những giai đoạn trong cuộc sống mọi nỗ lực dường như trôi qua trong im lặng, và rồi đến một thời điểm mọi thứ bắt đầu được nhìn thấy cùng lúc, như thể cả thế giới xung quanh cuối cùng cũng bắt kịp những gì bạn đã âm thầm làm.",
  ...
  },
  {
    ...
    "readingAdvice": "Có những giai đoạn cuộc sống đặt bạn vào vị trí phải bảo vệ một điều gì đó, có thể là một quyết định, một cách sống, một mối quan hệ, hay đơn giản là quyền được làm theo cách của riêng mình, trong khi xung quanh có nhiều tiếng nói khác đang cố gắng kéo bạn theo hướng khác.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một nhịp độ khác thường đang xuất hiện trong nhiều mặt của cuộc sống bạn, những việc từng dậm chân tại chỗ giờ bắt đầu chuyển động, tin tức đến nhanh hơn, và những quyết định bạn đã cân nhắc lâu giờ có cơ hội được thực hiện.",
  ...
  },
  {
    ...
    "readingAdvice": "Có thể gần đây bạn cảm nhận được một luồng năng lượng mới trong cuộc sống — một sự háo hức muốn thử điều gì đó khác, một tin tức bất ngờ sắp đến, hoặc đơn giản là cảm giác sẵn sàng bước ra khỏi những gì đã quá quen thuộc.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng sinh khí đang chảy qua giai đoạn này của bạn, kiểu năng lượng khiến bạn muốn làm gì đó, đi đâu đó, thay đổi điều gì đó, thay vì tiếp tục ở yên trong nhịp sống cũ.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một phiên bản vững vàng và rạng rỡ của bạn đang được thể hiện rõ trong giai đoạn này, thứ khiến những người xung quanh cảm nhận được sự ấm áp và vững vàng từ bạn mà không cần bạn phải cố gắng chứng minh điều gì.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một sự vững vàng đang lớn lên trong bạn lúc này, thứ cho phép bạn nhìn xa hơn những lo toan trước mắt và bắt đầu hình dung rõ ràng hơn về cuộc sống bạn muốn xây dựng cho chính mình.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng năng lượng mới, tươi mát đang bước vào cuộc sống của bạn lúc này, giống như một cánh cửa cảm xúc vừa được mở ra sau một thời gian khép kín.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một năng lượng kết nối đang xuất hiện trong cuộc sống của bạn lúc này, mang tính chất hai chiều và cân bằng, khác với những mối quan hệ mà bạn phải cố gắng một mình để duy trì.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một tinh thần vui tươi và gắn kết đang xuất hiện trong cuộc sống của bạn lúc này, nhắc bạn nhớ rằng nhiều niềm vui ý nghĩa nhất không đến từ những thành tựu cá nhân đơn lẻ, mà từ những khoảnh khắc được chia sẻ cùng người khác.",
  ...
  },
  {
    ...
    "readingAdvice": "Bạn đang ở trong một giai đoạn mà mọi thứ có vẻ nhạt nhòa hơn bình thường, không hẳn là tệ, chỉ là thiếu đi sự hào hứng từng có. Đây là trạng thái rất con người, khi tâm trí cần thời gian để tiêu hóa những gì đã trải qua trước khi sẵn sàng đón nhận điều tiếp theo.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác mất mát đang bao trùm lên bạn lúc này, có thể liên quan đến một mối quan hệ, một kế hoạch, hoặc một phần bản thân mà bạn từng gắn bó. Sự thất vọng này là thật, và nó xứng đáng được thừa nhận thay vì bị vội vàng gạt sang một bên để tỏ ra mạnh mẽ.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng năng lượng hoài niệm đang xuất hiện trong cuộc sống của bạn, có thể qua một người, một địa điểm, một kỷ niệm chợt ùa về, hoặc đơn giản là một cảm giác mơ hồ về sự đơn giản và an toàn của những ngày đã qua.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống của bạn lúc này có thể đang mở ra nhiều hướng đi cùng lúc, mỗi hướng mang một hứa hẹn riêng, một phiên bản khác của bạn mà bạn có thể trở thành.",
  ...
  },
  {
    ...
    "readingAdvice": "Có thể nhìn lại một chặng đường đã qua, bạn nhận ra mình đang có được nhiều điều mà trước đây từng mong ước, không nhất thiết là mọi thứ hoàn hảo, nhưng đủ để bạn cảm thấy cuộc sống của mình đang đi đúng hướng.",
  ...
  },
  {
    ...
    "readingAdvice": "Khi lá này xuất hiện ở vị trí tổng quát, nó thường phản ánh một giai đoạn mà nhiều khía cạnh trong cuộc sống của bạn, không chỉ một mảng riêng lẻ, đang cùng lúc mang lại cảm giác ổn định và ấm áp.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một điều gì đó mới mẻ đang bắt đầu trong đời sống của bạn lúc này, dù nó có thể chưa rõ hình hài, một mối quan hệ, một sở thích, một cơ hội, hoặc đơn giản là một cách nhìn khác về những gì quen thuộc.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một nguồn năng lượng lãng mạn và đầy cảm hứng đang chảy qua cuộc sống của bạn lúc này, có thể là một mối quan hệ, một dự định, một giấc mơ về cách bạn muốn cuộc đời mình trông như thế nào.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một sự cân bằng đang hình thành trong bạn lúc này, giữa việc cảm nhận sâu sắc mọi thứ xảy ra xung quanh và việc không để bản thân bị cuốn trôi theo những cảm xúc đó.",
  ...
  },
  {
    ...
    "readingAdvice": "Có những người, khi có mặt trong phòng, tự nhiên khiến không khí bớt căng thẳng hơn — không phải vì họ nói nhiều, mà vì cách họ hiện diện toát ra sự ổn định.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng minh mẫn đang đến với bạn ở giai đoạn này, giống như khi màn sương buổi sáng bất chợt tan để lộ ra toàn bộ khung cảnh mà trước đó chỉ thấy lờ mờ từng mảng.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một ngã rẽ nào đó trong cuộc sống hiện tại đang chờ bạn bước tới, và bạn chọn cách đứng yên ở giữa, không hẳn vì không biết mình muốn gì, mà vì cả hai hướng đi đều đòi hỏi bạn phải từ bỏ một điều gì đó quý giá.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một điều gì đó trong cuộc sống của bạn lúc này thật sự khiến bạn đau lòng, có thể liên quan đến một mối quan hệ, một kỳ vọng không thành, hay một sự thật bạn vừa nhận ra về hoàn cảnh của mình.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống đôi khi đặt bạn vào những tình huống mà thắng thua rất rõ ràng, và bạn đã ở phía thắng. Có thể đó là một cuộc tranh luận, một quyết định được thông qua theo ý bạn, hay đơn giản là việc bạn chứng minh được mình đúng trước người khác.",
  ...
  },
  {
    ...
    "readingAdvice": "Có thể gần đây bạn đã trải qua một giai đoạn không dễ dàng, dù đó là chuyện tình cảm, công việc, sức khỏe tinh thần hay một biến cố nào khác trong cuộc sống.",
  ...
  },
  {
    ...
    "readingAdvice": "Có những lúc trong cuộc sống, một chút khéo léo là điều cần thiết, biết chọn thời điểm, biết giữ im lặng khi chưa phải lúc nói, biết đi đường vòng để tránh một xung đột không cần thiết.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác bị vây kín đang hiện diện trong cuộc sống của bạn lúc này, như thể mọi lối ra đều đã bị chặn từ trước và bạn chỉ còn cách đứng yên tại chỗ.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác nặng nề đang bao trùm bạn lúc này, biểu hiện qua những đêm khó ngủ, những suy nghĩ lo âu lặp đi lặp lại, và đôi khi cả một cảm giác tội lỗi không rõ nguồn gốc cụ thể.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một điều gì đó trong cuộc sống của bạn vừa kết thúc theo cách đau đớn, có thể đột ngột hoặc sau một thời gian dài rạn nứt, và cảm giác kiệt quệ đi kèm theo đó là hoàn toàn dễ hiểu.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống của bạn lúc này có vẻ đang đưa đến nhiều thông tin mới hơn bình thường, từ những cuộc trò chuyện bất ngờ đến những tin tức khiến bạn phải dừng lại suy nghĩ.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng động lực mạnh mẽ đang đẩy bạn tiến về phía trước trong nhiều mặt của cuộc sống. Bạn không còn muốn chần chừ, muốn cân nhắc thêm, mà muốn thấy kết quả cụ thể từ những gì mình đã chuẩn bị bấy lâu.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một sự trưởng thành rõ rệt trong cách bạn đối diện với mọi việc gần đây, không còn dễ bị cuốn theo cảm xúc nhất thời hay ý kiến của số đông. Những gì bạn từng trải qua, kể cả những giai đoạn khó khăn, giờ đang trở thành nền tảng cho sự sáng suốt bạn có được hôm nay.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một luồng năng lượng rõ ràng, sắc bén đang hiện diện trong giai đoạn này của bạn, mời bạn nhìn thẳng vào mọi việc đúng như bản chất của chúng thay vì qua lăng kính của hy vọng hay lo sợ.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống của bạn trong giai đoạn này có thể đang đòi hỏi bạn phải cùng lúc quan tâm đến nhiều khía cạnh khác nhau, công việc, các mối quan hệ, sức khỏe, tài chính, và đôi khi cảm giác như đang tung hứng quá nhiều quả bóng cùng một lúc mà không chắc mình có giữ vững được tất cả hay không.",
  ...
  },
  {
    ...
    "readingAdvice": "Nhìn tổng thể, giai đoạn này của bạn được đánh dấu bởi sự xây dựng — từng bước, có phối hợp, và dựa trên nền tảng đang dần vững chắc hơn theo thời gian.",
  ...
  },
  {
    ...
    "readingAdvice": "Nhìn chung, đây là giai đoạn bạn có xu hướng giữ chặt những gì mình đã xây dựng được — dù là tiền bạc, mối quan hệ, vị trí công việc, hay đơn giản là thói quen sống quen thuộc.",
  ...
  },
  {
    ...
    "readingAdvice": "Nhìn tổng thể, đây có thể là một giai đoạn không dễ dàng — dù là về tài chính, sức khỏe tinh thần, các mối quan hệ, hay cảm giác chung rằng mọi thứ đang khó khăn hơn bình thường.",
  ...
  },
  {
    ...
    "readingAdvice": "Ở giai đoạn này, cuộc sống của bạn có thể đang xoay quanh những trao đổi qua lại với người khác, có thể là thời gian, sự chú ý, công sức hoặc những thứ cụ thể hơn.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một điều gì đó trong cuộc sống bạn đã dành khá nhiều thời gian và tâm sức để vun đắp, và đây là thời điểm phù hợp để dừng lại một chút, nhìn lại toàn cảnh thay vì cứ tiếp tục lao về phía trước mà không đánh giá.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một điều gì đó trong cuộc sống hiện tại đang cần đến sự kiên trì và chăm chút tỉ mỉ từ bạn, thay vì một cú bứt phá nhanh chóng. Có thể đó là một kỹ năng bạn đang học, một thói quen bạn đang xây dựng, hoặc đơn giản là cách bạn tiếp cận công việc hằng ngày với sự cẩn trọng hơn trước.",
  ...
  },
  {
    ...
    "readingAdvice": "Bạn đang đứng ở một điểm khá dễ chịu trong cuộc sống — mọi thứ không hoàn hảo, nhưng đủ vững để bạn cảm thấy có thể tự lo cho mình mà không cần dựa dẫm.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác bền vững đang hình thành trong cuộc sống của bạn lúc này, kiểu ổn định không đến trong một sớm một chiều mà được xây dựng qua nhiều lựa chọn nhỏ liên tiếp.",
  ...
  },
  {
    ...
    "readingAdvice": "Cuộc sống của bạn lúc này có thể đang mở ra một chương mới nào đó — chưa rõ ràng hoàn toàn, nhưng đầy tiềm năng để khám phá. Đây là giai đoạn phù hợp để giữ tinh thần của người mới bắt đầu: tò mò, sẵn sàng học hỏi, không ngại thừa nhận những gì mình chưa biết.",
  ...
  },
  {
    ...
    "readingAdvice": "Không phải mọi hành trình đều cần bắt đầu bằng một cú bứt phá. Lá này mang năng lượng của người cắm đầu làm việc, từng bước, không phô trương, và tin rằng sự đều đặn cuối cùng sẽ đưa mình đến nơi cần đến.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một sự ấm áp lặng lẽ trong năng lượng của lá này, kiểu ấm áp đến từ việc chăm sóc những gì đang có thay vì luôn hướng ra tìm kiếm điều gì mới. Dù đó là ngôi nhà bạn đang sống, những mối quan hệ bạn đang giữ, hay chính cơ thể và tâm trí của bạn, đây là lời mời để bạn dành thời gian vun đắp thay vì mở rộng thêm.",
  ...
  },
  {
    ...
    "readingAdvice": "Có một cảm giác trưởng thành bao trùm năng lượng của lá này, không phải sự trưởng thành chỉ vì tuổi tác mà là sự trưởng thành đến từ việc đã đi qua đủ nhiều để biết cách xây dựng một cuộc sống vững chắc theo cách của riêng mình.",
